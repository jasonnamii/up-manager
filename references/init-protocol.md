...
```
Agent-Ops/ 디렉토리를 탐색 → UP_user-preferences_*.md 파일명 확정
...
| 케이스 | 대응 |
|--------|------|
| Agent-Ops/ 디렉토리 존재, UP_user-preferences_*.md 0건 | STOP + 보고 "UP 본체 없음. 파일명 확인 요청" |
| UP_user-preferences_*.md 2건+ 발견 | 버전 번호 최고값 1개 선택 + 보고 "복수 버전 감지: [목록]" |
