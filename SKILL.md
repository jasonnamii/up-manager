...
description: |
  ...
  P1: UP, UP수정, UP관리, 버전범프, user preferences, invariant guard, DSL_LANG, KR단일블록, single block, 한글DSL, 팀UP, team sync, PERSONAL_FILTER, CODEBLOCK_WRAP. P2: 수정해줘, update, 한글로 써줘. P3: version bump, single-block sync.
